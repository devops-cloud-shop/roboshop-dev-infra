...
#vpn has given access to db servers -this is only for practice. In prod vpn  traffic reaches bastion and from bastion we can connect to db or private instances.
  vpn_ingress_rules = {
        mysql_22 = {
