...
# Redis Allow SSH connections from bastion on port 22
...
##### Bastion SG Rules #####
#Bastion allowing SSH access from Laptop
...
# When Developers want to check from brower they are given access to app port
